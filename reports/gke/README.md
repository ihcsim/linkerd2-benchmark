...
* The filter text field can be used to facilitate more detailed comparisons between the test runs. For example, to view the test result of all the 120 qps HTTP tests on the baseline echo servers, enter _http_baseline_120qps_ in the filter and hit ENTER.
* The legend of every chart can be clicked to toggle the inclusion and exclusion of data on the chart.

When at least 3 charts are displayed,
...
The report logs can be found in the [report-0qps-30s-32c.log](report-0qps-30s-32c.log) file.
...
-------------------- | ------------------------------------------- | --------------------------------
HTTP Baseline        | http://ld2.isim.me/?s=http_baseline_0qps_30 | Duration: 30s<br>qps range: 30k - 32k<br>Concurrent connections: 32<br>p99.9: 5.83ms - 5.96ms
HTTP Linkerd2-meshed | http://ld2.isim.me/?s=http_linkerd_0qps_30  | Duration: 30s<br>qps range: 10k - 11k<br>Concurrent connections: 32<br>p99.9: 9.23ms - 11.07ms
HTTP Istio-meshed    | http://ld2.isim.me/?s=http_istio_0qps_30    | Duration: 30s<br>qps range: 3.16k - 3.75k<br>Concurrent connections: 32<br>p99.9: 45.16ms - 72.00ms
GRPC Baseline        | http://ld2.isim.me/?s=grpc_baseline_0qps_30 | Duration: 30s<br>qps range: 15k - 16k<br>Concurrent connections: 32<br>p99.9: 9.38ms - 11.05ms
GRPC Linker2-meshed  | http://ld2.isim.me/?s=grpc_linkerd_0qps_30  | Duration: 30s<br>qps range: 7.36k - 7.86k<br>Concurrent connections: 32<br>p99.9: 12.39ms - 14.85ms
GRPC Istio-meshed    | http://ld2.isim.me/?s=grpc_istio_0qps_30    | Duration: 30s<br>qps range: 2.81k - 3.29k<br>Concurrent connections: 32<br>p99.9: 37.24ms - 71.71ms

Once the maximum qps is determined, per recommendation in the [FAQ](https://github.com/fortio/fortio/wiki/FAQ#i-want-to-get-the-best-results-what-flags-should-i-pass), the next test suite in this scenario attempts to load-test the echo servers at 75% of the of the previously determined maximum qps. A total of 10 test runs are performed, with each run configured to last for 5 minutes. In order to avoid incurring any sleep warnings, the lowest qps rates from the Istio-meshed runs are applied to all runs i.e. 0.75 * 3192 qps for HTTP load and 0.75 * 2817 qps for GRPC.

The report logs can be found in the [report-2374qps-5m-32c.log](report-2374qps-5m-32c.log) file.
...
Test Case            | URL                                            | Parameters And Response Time (ms)
-------------------- | ---------------------------------------------- | ---------------------------------
HTTP Baseline        | http://ld2.isim.me/?s=http_baseline_2374qps_5m | Duration: 5m<br>qps: 2374<br>Concurrent connections: 32<br>p99.9: 5.25ms - 5.85ms
HTTP Linkerd2-meshed | http://ld2.isim.me/?s=http_linkerd_2374qps_5m  | Duration: 5m<br>qps: 2374<br>Concurrent connections: 32<br>p99.9: 7.82ms - 9.34ms
HTTP Istio-meshed    | http://ld2.isim.me/?s=http_istio_2374qps_5m    | Duration: 5m<br>qps: 2374<br>Concurrent connections: 32<br>p99.9: 34.48ms - 40.12ms
GRPC Baseline        | http://ld2.isim.me/?s=grpc_baseline_2374qps_5m | Duration: 5m<br>qps: 2113<br>Concurrent connections: 32<br>p99.9: 9.52ms - 11.21ma
GRPC Linker2-meshed  | http://ld2.isim.me/?s=grpc_linkerd_2374qps_5m  | Duration: 5m<br>qps: 2113<br>Concurrent connections: 32<br>p99.9: 10.74ms - 12.80ms
GRPC Istio-meshed    | http://ld2.isim.me/?s=grpc_istio_2374qps_5m    | Duration: 5m<br>qps: 2113<br>Concurrent connections: 32<br>p99.9: 33.36ms - 45.64ms
